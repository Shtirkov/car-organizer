...
## Repo state (checked 2026-08-21)

`Shtirkov/car-organizer` carries GitHub's default labels plus the retired roadmap labels
(`feature`, `story`, `P0`, `P1`, `P2`). Of the five canonical roles only `wontfix` exists.
Create the other four before the first `/triage` run:
